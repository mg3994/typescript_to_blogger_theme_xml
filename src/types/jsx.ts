...
// Fallback empty DOM stub interfaces so the blogger theme compiles successfully
// even in environments without standard DOM library definitions (e.g., node-only, server-side, or React Native).
declare global {
  interface Event {}
