...
function normalizeChildren(children: any): Component[] {
  ...
  if (
    ...
    (typeof children === "object" &&
      "build" in children &&
      typeof children.build === "function")
  ) {
    return [children];
  }
  if (
...
export const Fragment = _Fragment || CoreFragment;

export function jsx(type: any, props: any, key?: any): Component {
  return createComponent(type, props) || _jsx;
}

export function jsxs(type: any, props: any, key?: any): Component {
  return createComponent(type, props) || _jsxs;
}
