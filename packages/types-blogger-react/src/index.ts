...
export namespace JSX {
  ...
  export type ElementClass = React.JSX.ElementClass & IntrinsicElements;
  ...
  export interface IntrinsicElements extends React.JSX.IntrinsicElements {
    "b:section": React.DetailedHTMLProps<
    ...
    "b:widget": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        id: string;
        type: string;
        title?: string;
    ...
    "b:widget-settings": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement>,
      HTMLElement
    >;
    "b:widget-setting": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { name: string },
      HTMLElement
    >;

    "b:if": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { cond: string },
      HTMLElement
    >;
    "b:elseif": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { cond: string },
      HTMLElement
    >;
    "b:else": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement>,
      HTMLElement
    >;

    "b:loop": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        values: string;
        var: string;
        index?: string;
    ...
    "b:include": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        name: string;
        data?: string;
        cond?: string;
    ...
    "b:includable": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        id: string;
        var?: string;
      },
    ...
    "b:attr": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        name: string;
        value: string;
        cond?: string;
    ...
    "b:class": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        name: string;
        cond: string;
      },
    ...
    "b:eval": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { expr: string },
      HTMLElement
    >;

    "b:with": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        var: string;
        value: string;
      },
    ...
    "b:switch": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { var: string },
      HTMLElement
    >;
    "b:case": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { value: string },
      HTMLElement
    >;
    "b:default": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement>,
      HTMLElement
    >;

    "b:message": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { name: string },
      HTMLElement
    >;
    "b:comment": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement>,
      HTMLElement
    >;

    "b:template-skin": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement>,
      HTMLElement
    >;
    "b:template-script": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & {
        name: string;
        version: string;
    ...
    "b:param": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { value?: string },
      HTMLElement
    >;

    "b:defaultmarkup": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement> & { type: string },
      HTMLElement
    >;
    "b:defaultmarkups": React.DetailedHTMLProps<
      React.HTMLAttributes<HTMLElement>,
      HTMLElement
    >;
